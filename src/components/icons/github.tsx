...
/**
 * GitHub's mark. lucide-react dropped its brand logos in 1.0, so the one
 * logo this interface needs is drawn here, sized and coloured like the
 * lucide icons beside it (the sidebar sets `size-4`; the fill follows the
 * text colour).
 */
