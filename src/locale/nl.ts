...
const translations = {
  ...
  info: {
    ...
    fanDuty: "{{value}} % duty",
    fanDutyNote:
      "De duty is het vermogen van de ventilator, volgens de eigen standentabel van het board. Een board zonder tabel toont in plaats daarvan de stand.",
  },
  network: {
  ...
  console: {
    ...
    inputNote:
      "Toetsen gaan precies zoals getypt naar de module, ook Ctrl-C, Tab en de pijltjestoetsen. De HTTP-schrijver hieronder voegt altijd een regeleinde toe en kan die dus niet sturen: gebruik hem vanuit scripts, niet bij een bootprompt.",
