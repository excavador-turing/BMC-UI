...
const translations = {
  ...
  info: {
    ...
    fanModeAutomatic: "Automatyczny",
    fanModeManual: "Ręczny",
    ...
    fanDutyNote:
      "Wypełnienie to moc wentylatora, według tabeli poziomów samej płyty. Płyta bez tabeli pokazuje zamiast tego bieg.",
  },
  network: {
  ...
  console: {
    ...
    inputNote:
      "Klawisze trafiają do modułu dokładnie tak, jak je wpisano, w tym Ctrl-C, Tab i strzałki. Zapis przez HTTP poniżej zawsze dodaje koniec linii, więc nie może ich wysłać: używaj go w skryptach, nie przy monicie rozruchu.",
  ...
  firmwareUpgrade: {
    ...
    promotionPassed: "Zaliczono",
    promotionRolledBack: "Przywrócono",
    promotionUnknown: "Zapisano",
    statusCurrent: "Aktualne",
    statusUpdate: "Dostępna aktualizacja · {{version}}",
    uploadButton: "Wgraj .tpu",
    sourcesButton: "Źródła",
    colVersion: "Wersja",
    colSource: "Źródło",
    colChecksum: "Suma kontrolna",
    showAllVersions: "Pokaż wszystkie wersje ({{count}})",
    slotNothingStaged: "nic nie przygotowano",
