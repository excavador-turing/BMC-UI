...
const translations = {
  ...
  info: {
    ...
    fanOverrideCeiling:
      "Jeśli płyta przekroczy {{celsius}} °C, demon sam odda wentylator regulatorowi.",
    ariaFanOverride: "Wstrzymaj regulator wentylatora {{device}}",
    fanReverted:
  ...
  network: {
    ...
    resetSwitchButton: "Zresetuj układ przełącznika",
    resetSwitchConfirm:
      "To resetuje układ przełącznika na płycie, nie adres BMC. Każdy port na chwilę pada: moduły obliczeniowe tracą łącze na kilka sekund, a BMC może również.",
  ...
  addressCard: {
    title: "Adres BMC",
    now: "Teraz:",
    noAddress: "brak adresu IPv4",
    via: "przez",
    dnsWord: "dns",
    leased: "przydzielony przez DHCP",
    fixed: "stały",
    mode: "Tryb adresu",
    dhcp: "DHCP",
    static: "Statyczny",
    addressLabel: "Adres / prefiks",
    gatewayLabel: "Brama",
    dnsLabel: "Serwery DNS, rozdzielone przecinkami",
    searchLabel: "Domena wyszukiwania",
    incomplete: "Wpisz adres z prefiksem, np. 192.168.1.20/24.",
    cannotCheck: "Nie udało się zapytać płyty o ten adres.",
    apply: "Zastosuj",
    tryIt: "Wypróbuj",
    ...
    revertNow: "Przywróć stary teraz",
    confirmFromThere:
      "Potwierdzenie liczy się tylko wtedy, gdy dotrze pod nowy adres — ta strona, otwarta tam. Z powłoki na płycie niczego nie dowodzi i jest odrzucane.",
  ...
  about: {
    ...
    firmware: "firmware",
    firmwareVersion: "Wersja firmware’u",
    daemonVersion: "Wersja demona",
    unavailable: "wersja niedostępna",
