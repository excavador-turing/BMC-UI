...
const translations = {
  ...
  info: {
    ...
    bmcStorage: "Almacenamiento del BMC",
    ...
    boardIp: "Dirección IP de la placa",
    ...
    fanDutyNote:
      "El ciclo es la potencia del ventilador, según la tabla de niveles de la propia placa. Una placa que no informa la tabla muestra el paso en su lugar.",
  },
  network: {
  ...
  console: {
    ...
    inputNote:
      "Las teclas llegan al módulo tal como se escriben, incluidos Ctrl-C, Tab y las flechas. El escritor HTTP de abajo siempre añade un fin de línea, así que no puede enviarlas: úsalo desde scripts, no en un prompt de arranque.",
  ...
  firmwareUpgrade: {
    ...
    promotionPassed: "Superado",
    promotionRolledBack: "Revertido",
    promotionUnknown: "Registrado",
    statusCurrent: "Actualizado",
    statusUpdate: "Actualización disponible · {{version}}",
    uploadButton: "Subir .tpu",
    sourcesButton: "Fuentes",
    colVersion: "Versión",
    colSource: "Fuente",
    colChecksum: "Suma de verificación",
    showAllVersions: "Mostrar las {{count}} versiones",
    slotNothingStaged: "nada preparado",
