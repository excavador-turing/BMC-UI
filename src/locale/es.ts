...
const translations = {
  ...
  network: {
    ...
    resetSwitchButton: "Restablecer el chip del switch",
    resetSwitchConfirm:
      "Esto restablece el chip del switch integrado, no la dirección del BMC. Todos los puertos caen un instante: los módulos pierden el enlace unos segundos, y el BMC también puede perderlo.",
  ...
  addressCard: {
    title: "La dirección del BMC",
    now: "Ahora:",
    noAddress: "sin dirección IPv4",
    via: "vía",
    dnsWord: "dns",
    leased: "concedida por DHCP",
    fixed: "fija",
    mode: "Modo de dirección",
    dhcp: "DHCP",
    static: "Estática",
    addressLabel: "Dirección / prefijo",
    gatewayLabel: "Puerta de enlace",
    dnsLabel: "Resolutores, separados por comas",
    searchLabel: "Dominio de búsqueda",
    incomplete: "Escriba la dirección con su prefijo, como 192.168.1.20/24.",
    cannotCheck: "No se pudo consultar a la placa sobre esta dirección.",
    apply: "Aplicar",
    tryIt: "Probar",
    ...
    tryingNow: "Lo está probando. Nada se conserva hasta que confirme.",
    confirm: "Conservar",
    confirmed: "Conservada. Un reinicio vuelve ahora a esto.",
    confirmFailed: "La dirección no se conservó",
    revertNow: "Restaurar la anterior ahora",
    confirmFromThere:
      "Una confirmación solo cuenta si llega a la nueva dirección — esta página, abierta allí. Desde un shell en la placa no prueba nada y se rechaza.",
  ...
  firmwareUpgrade: {
    ...
    checking: "consultando las fuentes ahora",
  ...
  about: {
    ...
    unavailable: "versión no disponible",
