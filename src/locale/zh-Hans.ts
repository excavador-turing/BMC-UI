...
const translations = {
  ...
  info: {
    ...
    metricsTokenTitle: "指标令牌",
    metricsTokenDescription:
      "仅可读取 /metrics 的凭据。它不是 root 密码：轮换它不会让任何人无法登录本界面，更改 root 密码也不会中断抓取。",
    metricsTokenShow: "显示令牌",
    metricsTokenUsername: "用户名",
    metricsTokenValue: "令牌",
    metricsTokenCreated: "创建于",
    metricsTokenReveal: "显示令牌",
    metricsTokenCopy: "复制令牌",
    metricsTokenRotate: "轮换",
    metricsTokenRotateConfirmTitle: "轮换指标令牌？",
    metricsTokenRotateConfirmBody:
      "当前令牌将立即失效。使用它的任何抓取都会开始失败，直到更新为止。",
    metricsTokenRotated: "已轮换。请更新所有使用旧令牌的抓取。",
    metricsTokenError: "无法读取令牌。此主板可能未挂载 overlay。",
