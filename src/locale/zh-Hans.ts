...
const translations = {
  ...
  info: {
    ...
    fanDuty: "占空比 {{value}} %",
    fanDutyNote:
      "占空比即风扇的功率，取自主板自身的档位表。未报告该表的主板改为显示档位。",
  },
  network: {
  ...
  console: {
    ...
    inputNote:
      "按键会原样发送到模块，包括 Ctrl-C、Tab 和方向键。下方的 HTTP 写入接口总会追加换行，因此无法发送这些按键：适合在脚本中使用，不适合在启动提示符下使用。",
  ...
  firmwareUpgrade: {
    ...
    firmwareSlots: "固件槽位",
    promotionPassed: "已通过",
    promotionRolledBack: "已回滚",
    promotionUnknown: "已记录",
    statusCurrent: "已是最新",
